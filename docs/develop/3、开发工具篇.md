...
- [IDEA](#idea)
  - [自定义模板快捷键](#自定义模板快捷键)
  - [JRebel热部署插件配置](#jrebel热部署插件配置)
    - [配置插件](#配置插件)
    - [常见问题](#常见问题)
  - [MyBatisCodeHelperPro代码生成器](#mybatiscodehelperpro代码生成器)
    - [地址](#地址)
    - [激活码](#激活码)
- [Vs code](#vs-code)
  - [vscode 设置打开新文件不覆盖前一个窗口](#vscode-设置打开新文件不覆盖前一个窗口)
  - [设置代码缩进tabSize](#设置代码缩进tabsize)
  - [格式化代码](#格式化代码)
  - [大小写转换快捷键](#大小写转换快捷键)
- [正则表达式](#正则表达式)
  - [数字相关](#数字相关)
...
<img src="assets/image-20210829111843841.png" alt="image-20210829111843841" />
...
添加 VM 参数后重启 Idea即可解决。

```
-Drecreate.x11.input.method=true
```

![image-20220414204451415](assets/image-20220414204451415.png)
