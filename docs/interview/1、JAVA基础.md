...
- [JAVA基础](#java基础)
  ...
  - [变量与方法](#变量与方法)
    ...
    - [一个类的构造方法的作用是什么？若一个类没有声明构造方法，程序能正确执行吗？为什么？](#一个类的构造方法的作用是什么若一个类没有声明构造方法程序能正确执行吗为什么)
    - [构造方法有哪些特性？](#构造方法有哪些特性)
  ...
  - [Java包](#java包)
    - [Java中的java、javax、sun、org包有什么区别](#java中的javajavaxsunorg包有什么区别)
    - [JDK 中常用的包有哪些](#jdk-中常用的包有哪些)
  - [IO流](#io流)
    - [java 中 IO 流分为几种?](#java-中-io-流分为几种)
    - [BIO,NIO,AIO 有什么区别?](#bionioaio-有什么区别)
    - [Files的常用方法都有哪些？](#files的常用方法都有哪些)
    - [IO中write、close和flush的区别](#io中writeclose和flush的区别)
    - [File类的getPath(),getAbsolutePath(),getCanonicalPath()区别](#file类的getpathgetabsolutepathgetcanonicalpath区别)
  - [反射](#反射)
    - [什么是反射机制？](#什么是反射机制)
    - [反射机制优缺点](#反射机制优缺点)
  ...
  - [java异常](#java异常)
    ...
    - [运行时异常和一般异常(受检异常)区别是什么？](#运行时异常和一般异常受检异常区别是什么)
    - [JVM 是如何处理异常的？](#jvm-是如何处理异常的)
    - [throw 和 throws 的区别是什么？](#throw-和-throws-的区别是什么)
    - [判断异常应该抛出还是捕获？](#判断异常应该抛出还是捕获)
    - [final、finally、finalize 有什么区别？](#finalfinallyfinalize-有什么区别)
    ...
    - [类 ExampleA 继承 Exception，类 ExampleB 继承ExampleA。](#类-examplea-继承-exception类-exampleb-继承examplea)
    - [常见的 RuntimeException 有哪些？](#常见的-runtimeexception-有哪些)
...
![image-20210617161652219](assets/image-20210617161652219.png)
