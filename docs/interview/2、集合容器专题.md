...
- [集合容器](#集合容器)
  - [集合容器概述](#集合容器概述)
    ...
    - [集合和数组的区别](#集合和数组的区别)
    - [使用集合框架的好处](#使用集合框架的好处)
    - [使用集合框架的好处](#使用集合框架的好处-1)
    - [常用的集合类有哪些？](#常用的集合类有哪些)
    - [List，Set，Map三者的区别？List、Set、Map 是否继承自 Collection 接口？List、Map、Set 三个接口存取元素时，各有什么特点？](#listsetmap三者的区别listsetmap-是否继承自-collection-接口listmapset-三个接口存取元素时各有什么特点)
  ...
  - [Map接口](#map接口)
    ...
    - [为什么HashMap中String、Integer这样的包装类适合作为K？](#为什么hashmap中stringinteger这样的包装类适合作为k)
...
![image-20210730113422070](C:/Users/孤影/Desktop/8.2/assets/image-20210730113422070.png)
...
例如：假设存在两个线程（线程1、线程2），线程1通过Iterator在遍历集合A中的元素，在某个时候线程2修改了集合A的结构（是结构上面的修改，而不是简单的修改集合元素的内容），那么这个时候程序就会抛出 **ConcurrentModificationException** 并发修改异常，从而产生fail-fast机制。
...
while(it.hasNext()){
   ...
   iterator.remove();//remove操作之前必须调用next操作，否则报IllegalStateException
}
```
...
![image-20210802154403801](C:/Users/孤影/Desktop/8.2/assets/image-20210802154403801.png)
...
![putVal方法执行流程图](C:/Users/孤影/Desktop/8.2/assets/20191214222552803.png)
...
>
> ![image-20210808221343362](assets/image-20210808221343362.png)
>
...
![image-20210808221405261](assets/image-20210808221405261.png)
...
![image-20210808220638008](assets/image-20210808220638008.png)

JDK1.7的ConcurrentHashMap：

![image-20210808220759739](assets/image-20210808220759739.png)

JDK1.8的ConcurrentHashMap（TreeBin: 红黑二叉树节点 Node: 链表节点）：

![image-20210808220825172](assets/image-20210808220825172.png)
...
![image-20210808220851443](assets/image-20210808220851443.png)
...
![image-20210808221100918](assets/image-20210808221100918.png)
