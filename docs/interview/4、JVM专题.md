...
- [JVM](#jvm)
  ...
  - [垃圾收集器](#垃圾收集器)
    ...
    - [Minor GC、Major GC和Full GC之间的区别以及触发的条件](#minor-gcmajor-gc和full-gc之间的区别以及触发的条件)
...
![image-20210708224019486](assets/image-20210708224019486.png)
...
![image-20210708224121491](assets/image-20210708224121491.png)
...
![image-20210708225238534](assets/image-20210708225238534.png)
...
![image-20210710231838303](assets/image-20210710231838303.png)
...
![image-20210710232314180](assets/image-20210710232314180.png)
...
![image-20210710233023180](assets/image-20210710233023180.png)
...
![image-20210710233741368](assets/image-20210710233741368.png)
...
![image-20210710233823644](assets/image-20210710233823644.png)
...
### Minor GC、Major GC和Full GC之间的区别以及触发的条件
...
- 老年代收集（Major GC/Old GC）：只针对 老年代的垃圾收集。目前，只有CMS收集器会有单独收集老年代的行为。注意，很多时候，Major GC 会和Full GC混淆使用，需要具体分辨是老年代的回收还是整堆回收。
- 混合收集（Mixed GC）：指目标是收集整个新生代以及部分老年代的垃圾收集。目前只有G1收集器会有这种行为。

**Minor GC触发条件**

1. 当年轻代（Eden区）满时就会触发 Minor GC，这里的年轻代满指的是 Eden区满。**Survivor 满不会触发 Minor GC 。**

**Major GC触发条件**

1. CMS收集器中，当老年代满时会触发 Major GC。目前，只有CMS收集器会有单独收集老年代的行为。其他收集器均无此行为。
...
![image-20210711094919930](assets/image-20210711094919930.png)
...
![image-20210711102733396](assets/image-20210711102733396.png)
...
![img](assets/061921034534396.png)
...
- -XX:SurvivorRatio=8：设置新生代 Survivor 和 Eden 比例为 2:8；
